...
data_gen = data_generator.DataGenerator("../data/code_f_indexed.txt", "../data/comment_f_indexed.txt", 0.20,
...
open('../model/code_local.json', 'w').write(json_string)
model.save_weights('../model/code_local.h5')
